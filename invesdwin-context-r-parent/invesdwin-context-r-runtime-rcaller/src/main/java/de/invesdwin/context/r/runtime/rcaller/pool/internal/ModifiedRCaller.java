...
public class ModifiedRCaller extends RCaller {
    ...
    public ModifiedRCaller() {
        super(null, new ROutputParserXML(), newOutputStreamHandler(), newErrorStreamHandler(), new MessageSaver(),
    ...
    private void quitOnErrorSetup() {
        ...
        getRCode().addRCode(RCallerScriptTaskRunnerR.INTERNAL_RESULT_VARIABLE + " <- c()");
        runAndReturnResultOnline(RCallerScriptTaskRunnerR.INTERNAL_RESULT_VARIABLE);
    }
