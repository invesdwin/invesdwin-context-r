...
public class ParametersAndReturnsTestFloat {
    ...
    public ParametersAndReturnsTestFloat(final IScriptTaskRunnerR runner) {
        this.runner = runner;
    }
    ...
    public void testFloat() {
        new AScriptTaskR<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestFloat.class.getSimpleName() + ".R",
