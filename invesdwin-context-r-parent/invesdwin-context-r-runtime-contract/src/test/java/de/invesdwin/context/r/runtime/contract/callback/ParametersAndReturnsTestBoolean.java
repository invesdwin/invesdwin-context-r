...
public class ParametersAndReturnsTestBoolean {
    ...
    public ParametersAndReturnsTestBoolean(final IScriptTaskRunnerR runner) {
        this.runner = runner;
    }
    ...
    public void testBoolean() {
        new AScriptTaskR<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestBoolean.class.getSimpleName() + ".R",
