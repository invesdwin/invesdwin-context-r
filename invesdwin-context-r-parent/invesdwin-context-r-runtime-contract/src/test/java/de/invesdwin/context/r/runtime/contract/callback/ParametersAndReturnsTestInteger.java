...
public class ParametersAndReturnsTestInteger {
    ...
    public ParametersAndReturnsTestInteger(final IScriptTaskRunnerR runner) {
        this.runner = runner;
    }
    ...
    public void testInteger() {
        new AScriptTaskR<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestInteger.class.getSimpleName() + ".R",
