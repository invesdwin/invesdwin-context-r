...
public class InputsAndResultsTestCharacter {
    ...
    public InputsAndResultsTestCharacter(final IScriptTaskRunnerR runner) {
        this.runner = runner;
    }
    ...
    public void testCharacter() {
        ...
        new AScriptTaskR<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestCharacter.class.getSimpleName() + ".R",
