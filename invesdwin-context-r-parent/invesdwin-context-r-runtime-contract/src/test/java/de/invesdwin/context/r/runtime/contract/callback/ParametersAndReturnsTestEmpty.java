...
public class ParametersAndReturnsTestEmpty {
    ...
    public ParametersAndReturnsTestEmpty(final IScriptTaskRunnerR runner) {
        this.runner = runner;
    }
    ...
    public void testEmpty() {
        new AScriptTaskR<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestEmpty.class.getSimpleName() + ".R",
