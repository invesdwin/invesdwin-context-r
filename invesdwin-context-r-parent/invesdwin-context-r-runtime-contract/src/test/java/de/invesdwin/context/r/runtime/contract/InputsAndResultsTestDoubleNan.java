...
public class InputsAndResultsTestDoubleNan {
    ...
    public InputsAndResultsTestDoubleNan(final IScriptTaskRunnerR runner) {
        this.runner = runner;
    }
    ...
    public void testDoubleNan() {
        ...
        new AScriptTaskR<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestDoubleNan.class.getSimpleName() + ".R",
