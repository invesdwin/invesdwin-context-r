...
public class InputsAndResultsTestNullPutGet {
    ...
    public InputsAndResultsTestNullPutGet(final IScriptTaskRunnerR runner) {
        this.runner = runner;
    }
    ...
    public void testNullPutGet() {
        new AScriptTaskR<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestNullPutGet.class.getSimpleName() + ".R",
