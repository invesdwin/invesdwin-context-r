...
public class ParametersAndReturnsTestString {
    ...
    public ParametersAndReturnsTestString(final IScriptTaskRunnerR runner) {
        this.runner = runner;
    }
    ...
    public void testString() {
        new AScriptTaskR<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestString.class.getSimpleName() + ".R",
