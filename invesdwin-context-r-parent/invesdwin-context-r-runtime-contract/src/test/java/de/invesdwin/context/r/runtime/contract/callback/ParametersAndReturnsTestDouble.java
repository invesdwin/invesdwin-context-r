...
public class ParametersAndReturnsTestDouble {
    ...
    public ParametersAndReturnsTestDouble(final IScriptTaskRunnerR runner) {
        this.runner = runner;
    }
    ...
    public void testDouble() {
        new AScriptTaskR<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestDouble.class.getSimpleName() + ".R",
