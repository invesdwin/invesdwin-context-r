...
public class ParametersAndReturnsTestNullPutGet {
    ...
    public ParametersAndReturnsTestNullPutGet(final IScriptTaskRunnerR runner) {
        this.runner = runner;
    }
    ...
    public void testNullPutGet() {
        new AScriptTaskR<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestNullPutGet.class.getSimpleName() + ".R",
