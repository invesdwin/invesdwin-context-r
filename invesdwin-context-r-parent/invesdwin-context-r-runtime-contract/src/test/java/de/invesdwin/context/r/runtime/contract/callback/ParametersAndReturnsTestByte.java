...
public class ParametersAndReturnsTestByte {
    ...
    public ParametersAndReturnsTestByte(final IScriptTaskRunnerR runner) {
        this.runner = runner;
    }
    ...
    public void testByte() {
        new AScriptTaskR<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestByte.class.getSimpleName() + ".R",
