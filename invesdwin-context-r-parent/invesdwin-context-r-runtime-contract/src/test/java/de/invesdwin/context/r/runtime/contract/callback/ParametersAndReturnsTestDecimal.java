...
public class ParametersAndReturnsTestDecimal {
    ...
    public ParametersAndReturnsTestDecimal(final IScriptTaskRunnerR runner) {
        this.runner = runner;
    }
    ...
    public void testDecimal() {
        new AScriptTaskR<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestDecimal.class.getSimpleName() + ".R",
