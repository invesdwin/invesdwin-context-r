...
public class InputsAndResultsTestEmptyMatrixValue {
    ...
    public InputsAndResultsTestEmptyMatrixValue(final IScriptTaskRunnerR runner) {
        this.runner = runner;
    }
    ...
    public void testEmptyMatrixValue() {
        ...
        new AScriptTaskR<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(InputsAndResultsTestEmptyMatrixValue.class.getSimpleName() + ".R",
