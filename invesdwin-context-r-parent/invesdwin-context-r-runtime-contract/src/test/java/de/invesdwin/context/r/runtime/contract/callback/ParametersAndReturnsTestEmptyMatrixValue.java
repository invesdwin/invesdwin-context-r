...
public class ParametersAndReturnsTestEmptyMatrixValue {
    ...
    public ParametersAndReturnsTestEmptyMatrixValue(final IScriptTaskRunnerR runner) {
        this.runner = runner;
    }
    ...
    public void testEmptyMatrixValue() {
        new AScriptTaskR<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestEmptyMatrixValue.class.getSimpleName() + ".R",
