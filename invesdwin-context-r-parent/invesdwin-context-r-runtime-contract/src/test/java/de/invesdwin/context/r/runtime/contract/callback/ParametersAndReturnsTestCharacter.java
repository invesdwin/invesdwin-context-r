...
public class ParametersAndReturnsTestCharacter {
    ...
    public ParametersAndReturnsTestCharacter(final IScriptTaskRunnerR runner) {
        this.runner = runner;
    }
    ...
    public void testCharacter() {
        new AScriptTaskR<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestCharacter.class.getSimpleName() + ".R",
