...
public class ParametersAndReturnsTestDoubleNan {
    ...
    public ParametersAndReturnsTestDoubleNan(final IScriptTaskRunnerR runner) {
        this.runner = runner;
    }
    ...
    public void testDoubleNan() {
        new AScriptTaskR<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestDoubleNan.class.getSimpleName() + ".R",
