...
public class InputsAndResultsTestString {
    ...
    public void testString() {
        ...
        //putStringMatrix
        final String[][] putStringMatrix = new String[3][];
        for (int i = 0; i < putStringMatrix.length; i++) {
            final String[] vector = new String[putStringMatrix.length];
        ...
        for (int i = 0; i < putStringMatrixNull.length; i++) {
        ...
        for (int i = 0; i < putStringMatrixAsListNull.size(); i++) {
            putStringMatrixAsListNull.get(i).set(i, null);
        }

        final AScriptTask task = new AScriptTask(
                new ClassPathResource("InputsAndResultsTestString", InputsAndResultsTestString.class)) {
            @Override
