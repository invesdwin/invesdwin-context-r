...
public class ParametersAndReturnsTestShort {
    ...
    public ParametersAndReturnsTestShort(final IScriptTaskRunnerR runner) {
        this.runner = runner;
    }
    ...
    public void testShort() {
        new AScriptTaskR<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestShort.class.getSimpleName() + ".R",
