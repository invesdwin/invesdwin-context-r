...
public class ParametersAndReturnsTestLong {
    ...
    public ParametersAndReturnsTestLong(final IScriptTaskRunnerR runner) {
        this.runner = runner;
    }
    ...
    public void testLong() {
        new AScriptTaskR<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestLong.class.getSimpleName() + ".R",
