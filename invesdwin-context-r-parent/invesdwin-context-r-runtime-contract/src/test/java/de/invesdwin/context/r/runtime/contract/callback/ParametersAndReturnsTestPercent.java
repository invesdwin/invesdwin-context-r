...
public class ParametersAndReturnsTestPercent {
    ...
    public ParametersAndReturnsTestPercent(final IScriptTaskRunnerR runner) {
        this.runner = runner;
    }
    ...
    public void testPercent() {
        new AScriptTaskR<Void>() {
            ...
            public void executeScript(final IScriptTaskEngine engine) {
                engine.eval(new ClassPathResource(ParametersAndReturnsTestPercent.class.getSimpleName() + ".R",
